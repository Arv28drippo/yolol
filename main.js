...
document.getElementById("sketch_needed").innerHTML = "Sketch To Be Drawn : " +element_of_array;
...
function check_sketch()
{
    ...
    if(timer_counter>555.555555555555555555)
    {
        timer_counter = 0;
...
function updateCanvas()
{
    background("white");
    sketch = element_of_array;
    document.getElementById("sketch_needed").innerHTML = "Sketch To Be Drawn Is : " + sketch;
}
